...
class Nfeedback{
    ...
    public void Abrir(){
        ...
        feedbacks = arquivo_feed.Abrir("Projeto_POO_14/feedbacks.xml");
        AtualizarFeedback();
    }
    ...
    public void Salvar(){   
        Arquivo <List<Feedback>> arquivo_feed = new Arquivo <List<Feedback>>();
        arquivo_feed.Salvar("Projeto_POO_14/feedbacks.xml", feedbacks);
    }
    ...
    public void FeedbackInserir(Feedback feedback){
        int maiorId = 0;
        maiorId = feedbacks.Max(maiorI => maiorI.id);
