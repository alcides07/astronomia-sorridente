...
class MainClass{
    ...
    private static Nfeedback nfeedback = Nfeedback.Singleton;
        ...
        while (operacao != 0){
            try{
                ...
                if (perfil == 1){
                    ...
                    switch(operacao){
                        case 0: operacao = 0; Console.WriteLine("Ao infinito e além!"); break;
                ...
                if (perfil == 2 && clienteLogin != null){
                    ...
                    switch(operacao){
                        case 0: perfil = 0; Console.WriteLine("Ao infinito e além!"); break;
...
//---------------------------- AÇÃO DO VENDEDOR ----------------------------
    ...
    public static void VendaListar(){
        ...
        var resposta1 = vendas.Select(v => new{
            Cliente = v.cliente.nome,
            Total = v.Itens.Sum(vi => vi.Qtd * vi.Valor)
        });

        Console.WriteLine(" ----------- Resumo do valor total gasto por cliente: -----------");
        var resposta2 = resposta1.GroupBy(item => item.Cliente,
        (chave, itens) => new{
            Cliente = chave,
        ...
        foreach(var item in resposta2){
            valor_total += item.Total;
            Console.WriteLine(item);
        }
        
        Console.WriteLine($"\nValor total de todas as vendas: R$ {valor_total:0.00}\n");
    }    
